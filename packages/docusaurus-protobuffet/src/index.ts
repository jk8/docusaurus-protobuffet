...
export default function preset(context: LoadContext, options: PresetOptions) {
  ...
  const config = {
    plugins: [
      [require.resolve("@jk8/docusaurus-protobuffet-plugin"), pluginOptions],
      ["@docusaurus/plugin-content-docs", docOptions],
    ],
  };
